...
class theme_afterburner_core_renderer extends core_renderer {
   ...
   /**
    ...
    protected function render_navigation_node(navigation_node $item) {
 	...
 	/**
	 * Permanent block docked position for settings block
	...
	function block(block_contents $bc, $region) {
		...
		//select the block to dock  and avoid the
		if (($testb == "block_settings  block" && $url[0]!="/course/view.php" && $url[0]!="/my/" && $url[0]!="/my/index.php") || $url[0]=="/mod/scorm/player.php") {
